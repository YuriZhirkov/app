<template>
  <div class="personalCenter">
        ...
        <h5>基本资料</h5>
            <div class="fmiddle">
                ...
                <!-- <div  class="flexs" @click="updateBasicInfo"> -->
                  <!-- <router-link class="w100 flexs" to="/personal/editBasicInfo"> -->
                  <router-link class="w100 flexs" to="/personal/multiInfo?i=1">
    ...
    <div class="sixBlock">
        ...
        <router-link to="/personal/multiInfo?i=2">
...
export default {
  ...
  methods: {
    ...
    uploadUserimg(file) {
      ...
      axios({
        ...
        .then(function(e) {
          ...
          self.post(
            "user/baseInfo/updateHeadUrl",
            { userId: self.userId, headUrl: e.data.data },
            function(e) {
              if (e.errCode != 200) {
    ...
    delImg2(url) {
      const self = this;
      this.post(
        "user/extendInfo/deleteOtherUrls",
        { otherUrl: url, userId: this.userId },
        function(e) {
          if (e.errCode != 200) {
    ...
    uploadImages() {
      const self = this;
      this.post(
        "user/extendInfo/uploadingOtherUrls",
        { userId: this.userId, otherUrls: this.imgUploadUrl },
        function(e) {
          if (e.errCode != 200) {
            self.$dialog.toast({ mes: e.errMsg, icon: "error" });
            return;
    ...
    updateSelfIntroductionDone() {
      ...
      if (this.edit == 1) {
        this.post(
          "user/extendInfo/addSelfIntroduction",
          {
            userId: this.userId,
            selfIntroduction: this.user1.selfIntroduction
          },
          function(e) {
            if (e.errCode != 200) {
              self.$dialog.toast({ mes: e.errMsg, icon: "error" });
        ...
        this.post(
          "user/extendInfo/addHeartBeatObject",
          { userId: this.userId, heartBeatObject: this.user2.heartBeatObject },
          function(e) {
            if (e.errCode != 200) {
              self.$dialog.toast({ mes: e.errMsg, icon: "error" });
              return;
